...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Your Productivity Pal is an AI-powered task manager that helps you organize your day and boost focus." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Your Productivity Pal is an AI-powered task manager that helps you organize your day and boost focus." },
